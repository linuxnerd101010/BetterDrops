...
import com.ln42.betterdrops.codingforcookies.ArmorEquipEvent.EquipMethod;

public class ArmorListsener implements Listener{
	private final List<String> blockedMaterials;

	public ArmorListsener(List<String> blockedMaterials){
